...
type ICodeceptCallback = (i: CodeceptJS.I, HomePageObject:any, RegistrationPageObject:any) => void;
...
declare namespace CodeceptJS {
  ...
  export interface HomePageObject {
    goToRegisterPageViaPopUp() : void,

  }


  export interface RegistrationPageObject {
    fillAccountDetails(country: string, username: string, email: string, password: string, confirmPassword: string) : void,
    fillUserDetails(title: string, firstName: string, lastName: string, dateOfBirthYear: string, dateOfBirthMonth: string, dateOfBirthDay: string, nationality: string, countryOfBirth: string, cityOfBirth: string) : void,
    fillContactDetails(streetAndHouseNo: string, city: string, postcode: string, mobilePhone: string) : void,
    tickCheckboxes(promotionalEmails: string, receiveNewsletter: string) : void,
    clickStoreDetails() : void,
    registerUser() : void,
